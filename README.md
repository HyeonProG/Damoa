...
## 1️⃣ 프로젝트 개요
### (1) 프로젝트 주제 및 목적
프리랜서와 기업이 서로의 필요를 충족시킬 수 있도록, **프리랜서**는 기업이 진행하는 프로젝트를 찾고, **기업**은 필요한 프리랜서를 쉽게 찾아볼 수 있는 양방향 매칭 시스템입니다.

프로젝트에 대한 **리뷰와 평가**를 바탕으로 더욱 신뢰성 있는 연결을 제공하고자 개발자와 기업 간의 양방향 매칭인 다모아를 만들었습니다.
